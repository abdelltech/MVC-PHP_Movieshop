<div class="row">
<table>
<caption>Are you sure you want to delete this movie ?</caption>
<thead>
...
<?php if(isset($data[0])): ?>
	<?php foreach ($data as $value): ?>
		<tr>
			...
			<?php if(isset($_SESSION['login'])): ?>
				<td>
					<a class="button" style="padding:10px 10px; border-radius:5px;" href="<?php echo BASE_URL?>index.php/Film/deleteFilm/<?= $value['idFilm']; ?>">OK</a>
				</td>
			<?php endif;?>
		</tr>
